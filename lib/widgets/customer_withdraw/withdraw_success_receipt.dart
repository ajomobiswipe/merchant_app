...
// STATEFUL WIDGET
class SuccessReceipt extends StatefulWidget {
  const SuccessReceipt({Key? key, this.receipt}) : super(key: key);
  final dynamic receipt;

  @override
  State<SuccessReceipt> createState() => _SuccessReceiptState();
}

// Success Receipt State Class
class _SuccessReceiptState extends State<SuccessReceipt> {
